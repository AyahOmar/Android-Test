...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
         ...
         *    provided code if necessary.  //Done
         *
         * 3. Read the additional 'TODO' comments throughout the codebase, they will guide you.   //Done
         *
         * 3. Please take care of the bug(s) we left for you in the project as well.   //Done
         *
